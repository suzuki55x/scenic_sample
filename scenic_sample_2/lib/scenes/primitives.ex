defmodule ScenicSample2.Scene.Primitives do
  @moduledoc """
  Sample scene.
  """
  ...
  alias ScenicSample2.Component.Nav
  alias ScenicSample2.Component.Notes
  ...
  @bird_path :code.priv_dir(:scenic_sample_2)
